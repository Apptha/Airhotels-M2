require(
          [ "jquery", "jquery/ui", "moment", "daterangepicker", "form-map",
                    "markerlabel", "responsiveslides", "priceslider", "searchmap"
          ...
          function(jQuery) {
               ...
               var zoomLatitude = [];
               function loadmarkers(co_ordinates, prezoomlevel, addressSearch,
                         price, northeastlat, northeastlng, southwestlat,
                         southwestlng) {
                    ...
                    if (datapoints.length > 1) {
                         ...
                         for (k = 0; k < (datapoints.length - 1); k++) {
                              ...
                              var details = '<div class="search-result-container"><a href="'
                                        ...
                                        + '" title="'
                                        + temp[3]
                                        + '"  class="matte2-media-box rslides1" style="text-decoration:none; text-transform:capitalize;"><div class="slider_showface"><img style="width: 100%;" src="'
                                        + temp[1]
