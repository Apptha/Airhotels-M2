...
/**
 * This class contains mass cities enabled functionality
 */
class Massenable extends Cities {
    /**
     *
     * @return void
     */
    public function execute() {
        ...
        foreach ( $enableIds as $enableId ) {
            try {
                /**
                 * Create cities plan object
                 */
                $citiesObj = $this->_objectManager->get ( 'Apptha\Airhotels\Model\City' );
                /**
                 * To enable cities plans
                 */
                $citiesObj->load ( $enableId )->setStatus ( 1 )->save ();
            } catch ( \Exception $e ) {
