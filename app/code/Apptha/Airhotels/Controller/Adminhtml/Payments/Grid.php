...
/**
 * This class contains the host payments grid action
 */
class Grid extends Payments {
    /**
     * Prepare host payments collection
     */
    protected function _prepareCollection() {
        /**
         * Getting factory collection for grid
         */
        $hostPayments = $this->_gridFactory->create ()->getCollection ();
        $this->setCollection ( $hostPayments );
        /**
