 ...
 *
 */
namespace Apptha\Airhotels\Block\Adminhtml\Allpayments;
/**
 * Class For Host payments grid
 */
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended {
    ...
    * @return void
    */
    public function __construct(\Magento\Backend\Block\Template\Context $context, \Magento\Backend\Helper\Data $backendHelper, \Magento\Framework\Module\Manager $moduleObj, array $data = []) {
    ...
    protected function _prepareCollection() {
        ...
        $collection = $objectManager->get ( 'Apptha\Airhotels\Model\Payments' )->getCollection ();
        $collection->addFieldToFilter ( 'host_id', array ('eq' => $hostId) );
        $this->setCollection ( $collection );
        parent::_prepareCollection ();
        return $this;
    }
    /**
     * Prepare columns for host payment
     * @return object
     */
    protected function _prepareColumns() {
        ...
        $objectManager = \Magento\Framework\App\ObjectManager::getInstance ();
        $options = $objectManager->get ( 'Apptha\Airhotels\Model\Config\Source\Optionsvalue' )->toOptionArray ();
