 ...
 *
 * */
namespace Apptha\Airhotels\Block\Adminhtml\Payments\Edit\Tab;
...
/**
 * Class Contains Host Commission Functions
 */
class Form extends Generic implements TabInterface {
    ...
    /**
     *
     * @var \Apptha\Airhotels\Model\System\Config\Status
     */
    protected $status;
    ...
    protected function _prepareForm() {
        /** @var $model \Apptha\Airhotels\Model\Host */
        $model = $this->_coreRegistry->registry ( 'airhotels_payments' );
        /**
         * Create form object
         */
         ...
         */
        $paymentsValues = '&nbsp;&nbsp;&nbsp;&nbsp;<input checked="checked" type="radio" name="payment_type" value="Paypal Id : ' . $data ['paypal'] . '" />' . __ ( 'PayPal' );
        $paymentsValues = $paymentsValues . '&nbsp;&nbsp;<input type="radio" name="payment_type" value="Bank Payment : ' . $data ['bankdetails'] . '" />' . __ ( 'Bank Payment' );
        /**
